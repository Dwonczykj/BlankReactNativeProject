...
//        var index: Int = -1
        ...
        if let userInfo = notification.userInfo {
            isSnooze = userInfo["snooze"] as? Bool ?? false
            soundName = userInfo["soundName"] as? String ?? ""
            id = userInfo["UUID"] as? String ?? userInfo["uuid"] as? String ?? "noID"
        }
        if soundName != "" {
          playSound(soundName)
          ...
          if isSnooze {
            let snoozeOption = UIAlertAction(title: "Snooze", style: .default) {
              ...
              self.alarmScheduler.setNotificationForSnooze(snoozeMinute: 9, soundName: soundName, id: id)
            }
...
//        var index: Int = -1
        ...
        if identifier == Id.snoozeIdentifier {
            alarmScheduler.setNotificationForSnooze(snoozeMinute: 9, soundName: soundName, id: id)
